...
namespace MyCompany.Rules
{
	public partial class DailyRegistrationBusinessRules : MyCompany.Data.BusinessRules
    {
        ...
        /// with a command name that matches "Report" and argument that matches "PrintDailyRegistrationPrint".
        /// </summary>
        [Rule("r100")]
        public void r100Implementation(DailyRegistrationModel instance, int Parameters_MemberID, int Parameters_PayTypeID, DateTime Parameters_FrDate, DateTime Parameters_ToDate)
        {
