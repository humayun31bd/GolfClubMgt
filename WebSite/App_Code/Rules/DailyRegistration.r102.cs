...
namespace MyCompany.Rules
{
	public partial class DailyRegistrationBusinessRules : MyCompany.Data.BusinessRules
    {
        ...
        /// </summary>
        [Rule("r102")]
        public void r102Implementation(DailyRegistrationModel instance, int Parameters_MemberID, int Parameters_PayTypeID, DateTime Parameters_FromDate, DateTime Parameters_ToDate)
        {
