...
namespace MyCompany.Rules
{
	public partial class CoachFeeReportBusinessRules : MyCompany.Data.BusinessRules
    {
        ...
        /// with a command name that matches "Report" and argument that matches "PrintCoachFeeStatement".
        /// </summary>
        [Rule("r100")]
        public void r100Implementation(CoachFeeReportModel instance, DateTime Parameters_FromDate, DateTime Parameters_ToDate)
        {
            ...
            string mySQL = String.Format("Pages/ClubReport.aspx?_ReportID=3&_FrYear=" + Parameters_FromDate.Year.ToString() + "&_FrMonth=" + Parameters_FromDate.Month.ToString() + "&_FrDay=" + Parameters_FromDate.Day.ToString() + "&_ToYear=" + Parameters_ToDate.Year.ToString() + "&_ToMonth=" + Parameters_ToDate.Month.ToString() + "&_ToDay=" + Parameters_ToDate.Day.ToString() + "&BookType=DailyCoachFee");
