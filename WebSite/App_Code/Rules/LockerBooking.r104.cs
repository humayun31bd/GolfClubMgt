...
namespace MyCompany.Rules
{
	public partial class LockerBookingBusinessRules : MyCompany.Data.BusinessRules
    {
        ...
        /// with a command name that matches "Custom" and argument that matches "MemberLockerClosed".
        /// </summary>
        [Rule("r104")]
        public void r104Implementation(LockerBookingModel instance, DateTime Parameters_FromDate)
        {
