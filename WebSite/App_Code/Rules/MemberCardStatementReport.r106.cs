...
{
	public partial class MemberCardStatementReportBusinessRules : MyCompany.Data.BusinessRules
    {
        ...
        /// </summary>
        [Rule("r106")]
        public void r106Implementation(MemberCardStatementReportModel instance, int Parameters_MemberID, DateTime Parameters_FromDate, DateTime Parameters_ToDate)
        {
            ...
            string mySQL = String.Format("Pages/ClubReport.aspx?_ReportID=5&_MemberID=" + Parameters_MemberID.ToString() + "&_FrYear=" + Parameters_FromDate.Year.ToString() + "&_FrMonth=" + Parameters_FromDate.Month.ToString() + "&_FrDay=" + Parameters_FromDate.Day.ToString() + "&_ToYear=" + Parameters_ToDate.Year.ToString() + "&_ToMonth=" + Parameters_ToDate.Month.ToString() + "&_ToDay=" + Parameters_ToDate.Day.ToString() + "");
