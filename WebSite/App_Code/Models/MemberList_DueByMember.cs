...
{
	public partial class MemberList_DueByMemberModel : BusinessRulesObjectModel
    {
        ...
        public MemberList_DueByMemberModel()
        {
        }
        
        public MemberList_DueByMemberModel(BusinessRules r) : 
                base(r)
        {
        }
