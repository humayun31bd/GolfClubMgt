...
namespace MyCompany.Services
{
    ...
    public partial class ApplicationServices : ApplicationServicesBase
    {
        ...
        {
            string qualifiedTypeName = typeName;
        ...
        public static void Initialize()
        {
            ...
            Assembly customCodeAssembly = typeof(ApplicationServices).Assembly;
            ...
            foreach (Type t in customCodeAssembly.GetTypes())
    ...
    public class ApplicationServicesBase
    {
        ...
        public static string FrameworkSiteContentControllerName = null;
