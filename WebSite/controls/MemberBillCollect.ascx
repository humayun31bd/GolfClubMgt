<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MemberBillCollect.ascx.cs" Inherits="Controls_MemberBillCollect" %>
<!-- 
    This section provides a sample markup for Desktop user inteface.
-->
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <div style="margin: 2px; border: solid 1px silver; padding: 8px;">uc:MemberBillCollect</div>
    </ContentTemplate>
</asp:UpdatePanel>
<!-- 
    This section provides a sample markup for Touch UI user interface. 
-->
<div id="MemberBillCollect"
    data-app-role="page" 
    data-activator="Button|MemberBillCollect"
...
<%--        <a href="../scripts/angular.min.js.map">../scripts/angular.min.js.map</a>--%>
                            ...
                            <div class="w3-row">
                                ...
                                <div class="w3-col m7">
                                    <p style="padding-left: 10px; padding-right: 5px">
                                        ...
                                        <%--{{ctrl.member.category}}--%><!--Defence Service Officer--></p>
                                </div>
                            </div>
                        </div>
                        <div class="w3-col m4">
