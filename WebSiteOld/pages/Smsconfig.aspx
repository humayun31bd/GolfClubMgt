...
<asp:Content ID="Content2" ContentPlaceHolderID="PageContentPlaceHolder" runat="Server">
  <div data-flow="row">
    ...
    <div data-activator="Tab|SMS Balance">
      <div id="view2" data-controller="Smsbalance" data-view="grid1" data-show-in-summary="true" data-selection-mode="multiple" data-show-action-bar="false" data-show-description="false" data-show-view-selector="false" data-show-quick-find="false"></div>
    </div>
    <div data-activator="Tab|SMS Purchased">
      <div id="view3" data-controller="Smspurchase" data-view="grid1" data-show-in-summary="true" data-selection-mode="multiple" data-show-action-bar="false" data-show-description="false" data-show-view-selector="false" data-show-quick-find="false"></div>
    </div>
  </div>
</asp:Content>
